...
import com.lapmaster.ui.theme.RacingGray
import com.lapmaster.ui.theme.RacingGreen
import com.lapmaster.ui.theme.RacingYellow

@Composable
fun MenuScreen(
    state: MenuUiState,
    weather: com.lapmaster.ui.model.WeatherUi,
    gps: com.lapmaster.ui.model.GpsUi,
    ...
    Column(
        ...
        com.lapmaster.ui.components.WeatherBanner(weather = weather, gps = gps)
